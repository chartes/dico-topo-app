...
class CommuneFacade(JSONAPIAbstractFacade):
    ...
    def get_departement_resource_identifier(self):
        return None if self.obj.departement is None else InseeRefFacade(self.url_prefix,
                                                                        self.obj.departement).resource_identifier

    def get_arrondissement_resource_identifier(self):
        return None if self.obj.arrondissement is None else InseeRefFacade(self.url_prefix,
                                                                           self.obj.arrondissement).resource_identifier
