...
from dico_topo.app import JSONAPIResponseFactory, api_bp, db
from dico_topo.app.api.facade_manager import JSONAPIFacadeManager
from dico_topo.app.api.search import SearchIndexManager
