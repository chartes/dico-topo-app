...
from dico_topo.app.api.place_comment.facade import PlaceCommentFacade, FlatPlaceCommentFacade
from dico_topo.app.api.place_description.facade import PlaceDescriptionFacade, FlatPlaceDescriptionFacade
from dico_topo.app.api.place_feature_type.facade import PlaceFeatureTypeFacade
from dico_topo.app.api.insee_commune.facade import CommuneFacade
from dico_topo.app.api.insee_ref.facade import InseeRefFacade, InseeRefSearchFacade
from dico_topo.app.api.place.facade import PlaceFacade, PlaceSearchFacade, PlaceMapFacade, LinkedPlaceFacade
from dico_topo.app.api.place_old_label.facade import PlaceOldLabelFacade, PlaceOldLabelSearchFacade, \
    PlaceOldLabelMapFacade, FlatPlaceOldLabelFacade
from dico_topo.app.api.bibl.facade import BiblFacade
from dico_topo.app.api.responsibility.facade import ResponsibilityFacade, FlatResponsibilityFacade
from dico_topo.app.api.user.facade import UserFacade
from dico_topo.app.models import Place, PlaceOldLabel, InseeCommune, InseeRef, PlaceFeatureType, Bibl, \
