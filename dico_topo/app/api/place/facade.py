...
from dico_topo.app.api.abstract_facade import JSONAPIAbstractFacade
...
class PlaceFacade(JSONAPIAbstractFacade):
    ...
    def get_resource_facade(url_prefix, id, **kwargs):
        from dico_topo.app.models import Place
            ...
            **self.resource_identifier,
            "attributes": {
                ...
                'inha-uri': 'https://thesaurus.inha.fr/thesaurus/page/ark:/54721/{0}'.format(
                    self.obj.commune.inha_uuid) if self.obj.commune and self.obj.commune.inha_uuid else None,
            },
            "meta": self.meta,
            "links": {
                "self": self.self_link
    ...
    def __init__(self, *args, **kwargs):
        ...
        from dico_topo.app.api.place_description.facade import PlaceDescriptionFacade
        from dico_topo.app.api.place_comment.facade import PlaceCommentFacade
