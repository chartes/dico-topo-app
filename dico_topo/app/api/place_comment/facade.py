...
from dico_topo.app.api.citable_content.facade import CitableContentFacade
from dico_topo.app.api.place_description.facade import rewrite_link_target
from dico_topo.app.models import PlaceComment, Place
